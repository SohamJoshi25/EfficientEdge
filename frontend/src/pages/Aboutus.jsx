...
const RutPFP = require('../assets/pfp/Rut.jpg')
const AboutUs = () => {
        ...
        <div>
            ...
            <div className="about-us-body">
                ...
                <div className="about-card about-flip">
                    ...
                    <div className="about-info">"Hello I'm Devayani Joshi I led this team in creating this amazing website . I manged teamwork, communicated effectively, and ensures the websites functionality and designed its appearance. " <a target="_blank" href="https://www.linkedin.com/in/devayani-joshi-280874269/">@LinkedIn</a></div>
                </div>
                <div className="about-card">
                ...
                <div className="about-card about-flip">
                    <div className="about-img"><img src={RutPFP} alt="" /></div>
                    <div className="about-info">"Hello i am Rutwik and i am a part of this team. I have helped in making this project and contributed in backend working of this project. Used Mongo DB and Express Library of JS using Node. "</div>
                </div>
            </div> 
        </div>
    );
